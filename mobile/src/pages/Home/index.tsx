      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined }>
        ...
        >
            <View style={styles.main}>
              <Image source={require('../../assets/logo_pequeno.png')} />

              {/* depois de colocarmos o KeyboardAvoidingView por volta os textos ficaram fixos entao colocamos View sem nada em volta */}
              <View>
                <Text style={styles.title}>Busque locais para descarte de resíduos</Text>
                <Text style ={styles.description}>Encontre pontos de coleta: descartar ecologicamente agora ficou bem mais fácil!</Text>
              </View>
            </View>
